  ...
  return (
    ...
    >
      ...
      <div className="basis-2/3 flex flex-col justify-center relative">
        <div className="glassmorphism-home absolute top-20 md:top-56 right-0 md:right-16">
          <h4>Total Music Playback</h4>
          <h5 className="text-2xl font-medium">
            50 <span className="text-xl">Hours</span>{" "}
          </h5>
        </div>
        <div className="glassmorphism-home flex flex-row gap-2 items-center absolute bottom-20 md:bottom-56 md:right-24">
